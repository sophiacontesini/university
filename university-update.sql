...
select distinct * from professores;


--criando uma view de aluons e professores

CREATE VIEW AlunosProfessoresView AS
SELECT ID, NumeroMatricula, Nome, Email, ValorMensalidade, NULL AS Salario, NULL AS Formacao
FROM Alunos
UNION
SELECT ID, NumeroMatricula, Nome, Email, NULL AS ValorMensalidade, Salario, Formacao
FROM Professores;

select * from alunosprofessoresview;
